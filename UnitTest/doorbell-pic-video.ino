...
const char* ssid = "OPPO A52";//"Julius_House";// "HOTBOX 4-5028";
const char* password = "ronyrony";//"RonyAyelet";// "0524302574";
...
void initSPIFFS(){
  ...
  //  Handle the error
  //  clenSPIFFSMemory();
  //  Serial.println("finish cleaning in setup, starting initSPIFFS again");
  //  initSPIFFS();
  //} 
}

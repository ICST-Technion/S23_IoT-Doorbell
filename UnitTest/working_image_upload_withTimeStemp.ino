...
const char* ssid = "HOTBOX 4-5028";
const char* password = "0524302574";
...
#define API_KEY "AIzaSyBbi4wM9ebaoAngNpCTyainvzhUPnV5hI0"

// Insert Authorized Email and Corresponding Password
#define USER_EMAIL "orental0506@gmail.com"
#define USER_PASSWORD "Dotangold1959!"

// Insert Firebase storage bucket ID e.g bucket-name.appspot.com
#define STORAGE_BUCKET_ID "esp-firebase-demo-f8eb5.appspot.com"
...
String getPictureFilename(){
  ...
  char timeString[50]; // OREN: changed from20 to 50
  strftime(timeString, sizeof(timeString), "%Y-%m-%d_%H:%M", &timeinfo);
  Serial.println(timeString);
  String filename = "/dataNew/" + String(timeString) +".jpg";
  //String filename = "/newData/photo1.jpg";
